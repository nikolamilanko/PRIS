...
@NamedQueries({ 
		...
		@NamedQuery(name = "Kurs11.findAllZaUsernamePredavaca", query = "SELECT k FROM Kurs11 k WHERE k.predavac11.logovanje11.idlogovanja=(SELECT l.idlogovanja FROM Logovanje11 l WHERE l.username=:username)")
})
@Table(name = "KURS11")
