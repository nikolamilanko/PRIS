 ...
 */
@Entity
@NamedQuery(name="Odgovornapitanj11.findAll", query="SELECT o FROM Odgovornapitanj11 o")
@Table(name="ODGOVORNAPITANJ11")
public class Odgovornapitanj11 implements Serializable {
