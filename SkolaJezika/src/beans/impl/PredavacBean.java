...
public class PredavacBean {
	...
	public boolean login(String username, String password) {
		...
		try {
			TypedQuery<Predavac11> query = em.createQuery(
					"select p from Predavac11 p where p.logovanje11.idlogovanja=(select l.idlogovanja from Logovanje11 l where l.username=:username and l.password=:password)",
					Predavac11.class);
